...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    String agentId = "", name, userRole = "", userName = "", userContactNo = "", vendorId = "", vendorName = "", parkingName = "", parkingType = "", parkingId = "", userType = "", SelectedVehicleType1/*, parkingType12 = ""*/, subVehicleNo = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.e(TAG, "SelectVehicleType1: " + SelectVehicleType1);
    ...
    private void addRadioButtons(int length) {
        ...
        for (int i = 0; i < length; i++) {
            Log.e(TAG, "addRadioButtons:======SelectVehicleType1========== " +SelectVehicleType1);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                ...
                switch (menuItem.getItemId()) {
                    ...
                    case R.id.nav_carInActivityTwo:
                        intent = new Intent(MainActivity.this, WheelerList.class);
                        startActivity(intent);
                        overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left);
                        return true;
                    case R.id.nav_sub:
    ...
    public void onClick(View v) {
        ...
        if (v == btnCheckIn) {
            Log.e(TAG, "onClick: -===============================" + TextUtils.isEmpty(SelectVehicleType1));
            if (AppConstants.isInternetAvailable(MainActivity.this)) {
                validate();
            } else {
                NoIternetConnection(MainActivity.this);
    ...
    private void validate() {
        ...
        if (userType.equals("VIP")) {
            if (AppConstants.isBlank(vipvehicleNumber)) {
                if (TextUtils.isEmpty(SelectVehicleType1)) {
                    // if (SelectVehicleType1.equals("") && SelectVehicleType1.equals("null")) {
                    AppConstants.showToast(MainActivity.this, getString(R.string.select_vehicle_type));
                } else {
                    chechIn();
                }
            } else {
            ...
            if (userType.equals("Online")) {
                ...
                if (AppConstants.isBlank(otpVehicleNumber.getText().toString())) {
                    ...
                    AppConstants.showToast(MainActivity.this, getString(R.string.enter_otp_required));
                } else {
                    if (TextUtils.isEmpty(SelectVehicleType1)) {
                        //if (SelectVehicleType1.equals("") && SelectVehicleType1.equals("null")) {
                        AppConstants.showToast(MainActivity.this, getString(R.string.select_vehicle_type));
        ...
        if (AppConstants.isInternetAvailable(MainActivity.this)) {
            if (userType.equals("VIP")) {
                if (!vipinfo.getText().toString().equals("")) {
                    ...
                    AppConstants.showToast(MainActivity.this, getString(R.string.enter_vIP_info));
        ...
        JsonObjectRequest jsonObjReq = new JsonObjectRequest(Request.Method.GET, urlData, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    //unexpected_error
                    AppConstants.showToast(MainActivity.this, getString(R.string.unexpected_error));
                    pDialog.dismiss();
                ...
                try {
                    ...
                    if (status == 0) {
                        ...
                        for (int i = 0; i < arrayObj.length(); i++) {
                            ...
                            textToolHeader.setText(jsonObject.getString("name"));
                ...
                try {
                     ...
                     */   // etStateCode.setFocusable(false);
                        ...
                        if (getprintReceipt.equals("no")) {
                            ...
                            availableSlotSevice(parkingId, SelectVehicleType1, MainActivity.this.agentId);
...
//                        showResultInfo("Print Exception", "Error", message);
    ...
    public void printNormal(Context newEntryActivity, Printer printer) {
        ...
        if (storeAllValues.getString("parkingPrint", "").equals("checkInModel")) {
            ...
            printer.printQrCode(barCode, 230, Printer.Gravity.CENTER);
    ...
    public void id(Intent intent) {
        ...
        if (tagID.equals("")) {
            ...
            if (AppConstants.isNetworkAvailable(MainActivity.this)) {
                ...
                AppConstants.showToast(MainActivity.this, getString(R.string.internet_connection_required));
