package attender.oparkReceiptNew.booking;
...
public class QRScanPrint extends AppCompatActivity implements QRCodeReaderView.OnQRCodeReadListener {
    ...
    private View view;
    public static final String TAG = "QRScanPrint";
    ...
    String getParkingID,SelectVehicleType1,agentId, userRole, userName, userContactNo, vendorId, vendorName, parkingName, parkingType, parkingId,
...
//        pType4 = pType[1];
    ...
    public void onQRCodeRead(String text, PointF[] points) {
        disableView(false);
        mQRCode = text;
        Log.e(TAG, "onQRCodeRead: " + mQRCode );
    ...
    private void setData(String qrCodeData) {
        ...
        if (userTypeOnline.equals("Online")) {
            if (AppConstants.isInternetAvailable(QRScanPrint.this)) {
                ...
                Log.e(TAG, "setData:SelectVehicleType1 " + SelectVehicleType1);
                Log.e(TAG, "setData:data " + data);
                Log.e(TAG, "setData:agentId " + agentId);
                Log.e(TAG, "setData:userTypeOnline " + userTypeOnline);
                Log.e(TAG, "setData:tagID " + tagID);

                vehicleCheckIn(parkingId, SelectVehicleType1, data, agentId, userTypeOnline, "", tagID);
            } else {
                NoIternetConnection(QRScanPrint.this);   }
        } else {
