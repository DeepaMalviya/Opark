package attender.oparkReceiptNew.splash;
...
import attender.oparkReceiptNew.parkinglist.ParkingList;
import attender.oparkReceiptNew.towingoperator.activity.AddTowVehicle;
...
public class Splash extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getParkingType = sharedpref.getString("getParkingType", "");
        /*if (AppConstants.isInternetAvailable(Splash.this)) {

        } else {
            NoIternetConnection(Splash.this);
