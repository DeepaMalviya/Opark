...
public class FourWheelerCheckInAdapter extends RecyclerView.Adapter<FourWheelerCheckInAdapter.ViewHolder> {
    ...
    WheelerCheckInFragment fourWheelerCheckInFragment;
    private ArrayList<VehicleModelDetails> vehicleModelList = new ArrayList<>();

    public FourWheelerCheckInAdapter(WheelerCheckInFragment fourWheelerCheckInFragment, ArrayList<VehicleModelDetails> vehicleModelList) {
