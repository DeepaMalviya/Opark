package attender.oparkReceiptNew.subscription.model;

/**
 * Created by Daffodil on 7/4/2018.
 */

public class SubscriptionModelNew {

    String isPass,cardNo,agentId,vehicleNo,plan,total,holderName,passHeading,renewableDate,receiptHeading,parkingAddress,companyWebsite,poweredBy , passNumber,address,mobileNo,cardHolderName;
boolean checkin;
