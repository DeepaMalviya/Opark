...
//    private TextInputLayout textInputLayoutConfirmPassword;
    ...
    String agentId, SelectVehicleType1, userRole, userName, userContactNo, vendorId, vendorName, parkingName, parkingType, parkingId, vehicleNo, AgentName, ParkingName, holderName, passHeading, plan, total, renewableDate,
...
//        pType4 = pType[1];
        ...
        if (AppConstants.isInternetAvailable(Subscription.this)) {
            ...
            NoIternetConnection(Subscription.this);
        }
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            if (status == 0) {
                                ...
                                for (int j = 0; j <planlId.size() ; j++) {
                                    Log.e(TAG, "onResponse:-========= "+planlId.get(j) );
                                }
                                ...
                                spinnerplan.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                                    ...
                                    public void onItemSelected(AdapterView<?> parent, View view, int pos, long id) {
                                        ...
                                        try {
                                            subPlanId = planlId.get(pos-1);
                                           String subPlan = plannames.get(pos);
                                            ...
                                            Log.e(TAG, "onItemSelected:subPlanId=== " + subPlan);
