...
import attender.oparkReceiptNew.subscription.model.PassDetailModel;
import attender.oparkReceiptNew.subscription.adapter.ShowCardDetailAdapter;
...
public class ShowCardDetail extends AppCompatActivity {
    ...
    private void sendError(String e, String apiName) {
        ...
        if (AppConstants.isInternetAvailable(ShowCardDetail.this)) {
            ...
            NoIternetConnection(ShowCardDetail.this);  }
    }
