package attender.oparkReceiptNew.subscription.activity;
...
import attender.oparkReceiptNew.subscription.model.InputValidation;
...
public class RenewCard extends AppCompatActivity implements View.OnClickListener {
    private static final String TAG = "RenewCard";
    private Toolbar toolBar;
    private TextView textToolHeader;
    String tagID, SelectVehicleType1;
...
//    private String subCardNo = "";
    ...
    String agentId, userRole, userName, userContactNo, vendorId, vendorName, parkingName, parkingType, parkingId, vehicleNo, AgentName, ParkingName, holderName, passHeading, plan, total, renewableDate,
            pType2, pType4, parkingVehicle, sidefour, userType, getParkingID, parkingType1234, name, mobileNumber, subDurationId, subPlanId, planename, varient1;
    ...
    private void initViews() {
        ...
        if (AppConstants.isInternetAvailable(RenewCard.this)) {
            ...
            planService(SelectVehicleType1);
        } else {
            NoIternetConnection(RenewCard.this);
        }
                               ...
                               /* spinnerDurationn.setAdapter(new ArrayAdapter(RenewCard.this,
                                ...
                                spinnerplan.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                                    ...
                                    public void onItemSelected(AdapterView<?> parent, View view, int pos, long id) {
                                     ...
                                     String   subPlan = planeList.get(pos).getPlanName();
                                        Log.e(TAG, "onItemSelected: subPlanId"+subPlanId );
                                        Log.e(TAG, "onItemSelected: subPlan"+subPlan );
                                    }
...
//                        showResultInfo("Print Exception", "Error", message);
    ...
    private void verifyFromSQLite() {
       ...
       /* if (Price.equals("")) {
        ...
        } else if (subPlanId.equals("")) {
            setSpinnerError(spinnerplan, "Select Plan");
        } else if (subDurationId.equals("")) {
            setSpinnerError(spinnerDurationn, "Select Duration");
        } else {
            Price = TvPricee.getText().toString().trim();
            sharedpref = getSharedPreferences("opark", Context.MODE_PRIVATE);
